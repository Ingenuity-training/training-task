import {
  ...
  private endText(): void {
    ...
    const  toptitle= new BitmapText('Hey!! You Did it!!',{fontName:'Desyrel', fontSize: 120,
    align: 'center',});
    toptitle.anchor.set(0.5,0.5);
    toptitle.x =this.app.view.width/2;
    toptitle.y =toptitle.height;
    
    const stop = new BitmapText(`Play More... Grow More`, {
      fontName: 'Desyrel',
      fontSize: 50,
      align: 'center',
    });
    ...
    stop.on('pointerup', () => {
      ...
      this.stage.removeChild(this.stop);
    });
    ...
    // this.game.visible=true;
      ...
      private createStartText(): void {
        const title = new BitmapText('Let’s Take The Challenges \n Level Up Today', {
          fontName: 'Desyrel',
          fontSize: 80,
          align: 'center',
        });
        ...
        const start = new BitmapText('Start With The Memory Game', {
          fontName: 'Desyrel',
          fontSize: 60,
          align: 'center',
        });
