...
function loadComplete(
  ...
  setTimeout(() => {
    ...
    // (<HTMLDivElement>document.querySelector('#message')).innerHTML = '<div style="color:black;"><b>Continue</b></div>';
    (<HTMLDivElement>document.getElementById("message")).innerHTML = "Continue"; 
